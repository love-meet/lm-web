  ...
  const settingsSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "contact-us", label: "Contact Support", icon: FaEnvelope, action: () => console.log("Contact Support") },
        { id: "feedback", label: "Send Feedback", icon: FaHeart, action: () => console.log("Feedback") },
        { id: "about", label: "About Love Meet", icon: FaInfoCircle, action: () => console.log("About") }
      ]
    }
  ];
