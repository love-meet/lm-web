...
const MobileNavbar = () => {
  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 md:hidden bg-gradient-to-r from-[var(--bg-primary)] to-[var(--bg-secondary)] backdrop-blur-lg border-b border-white/10 transition-transform duration-300 ${
    ...
    >
      <div className="flex items-center justify-between px-6 py-2">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Profile Picture */}
          <button className="w-8 h-8 rounded-full overflow-hidden border-2 border-[var(--primary-cyan)] hover:border-[var(--accent-pink)] transition-colors">
            <img 
